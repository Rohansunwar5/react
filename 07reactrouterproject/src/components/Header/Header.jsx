...
// in react a tag is not used beacuse it reloads the whole page, whereas in the wokring of react  we use components and re rendering is done through dom tree
